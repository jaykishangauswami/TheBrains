...
public class AccountAdapter extends BaseExpandableListAdapter {
    Context context;
    ArrayList<ModelAccounts> model_elvs;

    public AccountAdapter(Context context, ArrayList<ModelAccounts> model_elvs) {
    ...
    public int getChildrenCount(int groupPosition) {
        ArrayList<ModelAccountChild> chList = model_elvs.get(groupPosition).getItems();
        return chList.size();
    }
    ...
    public Object getChild(int groupPosition, int childPosition) {
        ArrayList<ModelAccountChild> childses = model_elvs.get(groupPosition).getItems();
    ...
    public View getChildView(int groupPosition, int childPosition, boolean isLastChild, View convertView, ViewGroup parent) {
        ...
        ModelAccountChild child = (ModelAccountChild) getChild(groupPosition, childPosition);
        if (convertView == null) {
